...
A fully-featured 11v11 football (soccer) simulation game built with TypeScript, React, and Canvas. Initially generated by Claude, and then tweaked to work well.
...
- **Intelligent Decisions** - Intelligent player behavior including possession, passing, and tactical positioning
